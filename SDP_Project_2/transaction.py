...
class TransactionFrame(tk.Frame):
    ...
    def create_widgets(self):
        ...
        tk.Label(self, text="Transaction Details", background="pale goldenrod",font=("Helvetica", 16,"bold")).grid(row=0, column=0, padx=10, pady=10, columnspan=2)

        tk.Label(self, text="Customer ID:", background="pale goldenrod",font=("Helvetica", 12,"bold")).grid(row=1, column=0, padx=10, pady=5, sticky='e')
        ...
        tk.Label(self, text="Delivery Date:", background="pale goldenrod",font=("Helvetica", 12,"bold")).grid(row=2, column=0, padx=10, pady=5, sticky='e')
        ...
        self.cloth_frame = tk.Frame(self, background="pale goldenrod")
        self.cloth_frame.grid(row=3, column=0, columnspan=2, padx=10, pady=10)
        
        self.add_cloth_entries()

        self.add_transaction_button = tk.Button(self, text="Add Transaction", command=self.add_transaction,font=("Helvetica", 12), bg="blue", fg="white")
        ...
        self.view_transactions_button = tk.Button(self, text="View Transactions", command=self.view_transactions,font=("Helvetica", 12), bg="blue", fg="white")
        self.view_transactions_button.grid(row=6, column=0, columnspan=2, padx=10, pady=10)

        self.update_status_button = tk.Button(self, text="Update Status", command=self.update_status,font=("Helvetica", 12), bg="blue", fg="white")
        ...
        self.back_to_customer_button = tk.Button(self, text="Back", command=lambda: self.controller.show_frame("CustomerFrame"),font=("Helvetica", 12), bg="blue", fg="white")
        self.back_to_customer_button.grid(row=8, column=0, columnspan=2, padx=10, pady=10)

        self.signout_button = tk.Button(self, text="Sign Out", command=lambda: self.controller.show_frame("LoginFrame"),font=("Helvetica", 12), bg="blue", fg="white")
    ...
    def add_cloth_entries(self):
        ...
        cloth_type_label = tk.Label(self.cloth_frame, text="Cloth Type:",font=("Helvetica", 12,"bold"))
        ...
        laundry_type_label = tk.Label(self.cloth_frame, text="Laundry Type:",font=("Helvetica", 12,"bold"))
        ...
        cost_label = tk.Label(self.cloth_frame, text="Cost:",font=("Helvetica", 12,"bold"))
        ...
        self.add_cloth_button = tk.Button(self.cloth_frame, text="Add Cloth", command=self.add_cloth_entries,font=("Helvetica", 12))

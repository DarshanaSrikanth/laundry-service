...
class ReportFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Reports", background="pale goldenrod",font=("Helvetica", 16,"bold")).grid(row=0, column=0, padx=10, pady=10, columnspan=3)
        ...
        self.daily_report_button = tk.Button(self, text="Daily Report", command=lambda: self.generate_report('daily'),font=("Helvetica", 12), bg="blue", fg="white")
        self.daily_report_button.grid(row=8, column=0, padx=10, pady=10)

        self.weekly_report_button = tk.Button(self, text="Weekly Report", command=lambda: self.generate_report('weekly'),font=("Helvetica", 12), bg="blue", fg="white")
        self.weekly_report_button.grid(row=8, column=1, padx=10, pady=10)

        self.monthly_report_button = tk.Button(self, text="Monthly Report", command=lambda: self.generate_report('monthly'),font=("Helvetica", 12), bg="blue", fg="white")
        self.monthly_report_button.grid(row=8, column=2, padx=10, pady=10)

        self.back_to_transaction_button = tk.Button(self, text="Back", command=lambda: self.controller.show_frame("TransactionFrame"),font=("Helvetica", 12), bg="blue", fg="white")
